            ...
            <div className="container mx-auto max-w-6xl px-4 md:px-6">
                <div className="mb-12 flex flex-col items-center">
                    ...
                    <p className="text-muted-foreground max-w-2xl text-center">
                        Find answers to common questions about MVPBlocks and how to use our components to build your
                        next project.
                    </p>
                </div>
                    ...
                    <AnimatePresence>
                        {filteredFaqs.map((faq, index) => (
                            ...
                            >
                                ...
                                >
                                    <h3 className="text-foreground text-lg font-medium">{faq.question}</h3>
